...
export const MOCK_LISTINGS: NormalizedListing[] = [
  {
    ...
    agents: [
      { name: 'Chirag Yadav', phone: '0479 092 216', email: 'chirag@krishrealestate.com.au', photo: '/images/agent-chirag.jpg' },
    ],
  ...
  },
  {
    ...
    propertyType: 'House',
    address: {
      display: '54 Saltlake Boulevard, Wollert VIC 3750',
      street: '54 Saltlake Boulevard',
      suburb: 'Wollert',
      state: 'VIC',
      postcode: '3750',
    },
    price: { display: 'Sold — $820,000', from: 820000 },
    beds: 4,
    baths: 3,
    cars: 2,
    landSize: 512,
    description: 'An architectural contemporary residence in the prestigious Amberton precinct of Wollert, achieving a street benchmark outcome through Krish Real Estate.',
    features: ['Dual Living Areas', 'Butler Pantry', 'Refrigerated Cooling', 'Landscaped Grounds', 'Alfresco Dining'],
    media: [
      { url: '/images/listing-3.jpg', alt: '54 Saltlake Boulevard, Wollert — Sold for $820,000', type: 'image' },
    ],
    inspections: [],
    agents: [
      { name: 'Chirag Yadav', phone: '0479 092 216', email: 'chirag@krishrealestate.com.au', photo: '/images/agent-chirag.jpg' },
    ],
    slug: '54-saltlake-boulevard-wollert-3750',
  ...
  },
  {
    ...
    propertyType: 'House',
    address: {
      display: '12 Lyndarum Drive, Epping VIC 3076',
      street: '12 Lyndarum Drive',
      suburb: 'Epping',
      state: 'VIC',
      postcode: '3076',
    },
    price: { display: 'Leased — $620 / wk', from: 620 },
    beds: 4,
    baths: 2,
    cars: 2,
    landSize: 440,
    description: 'Secured quality executive tenants within 11 days of going live on market. Exceptional rental yield achieved for interstate landlord.',
    features: ['Ducted Heating', 'Evaporative Cooling', 'Walk to Lyndarum Shops', 'Low Maintenance'],
    media: [
      { url: '/images/listing-2.jpg', alt: '12 Lyndarum Drive, Epping — Leased $620/wk in 11 days', type: 'image' },
    ],
    inspections: [],
    agents: [
      { name: 'Chirag Yadav', phone: '0479 092 216', email: 'chirag@krishrealestate.com.au', photo: '/images/agent-chirag.jpg' },
    ],
    slug: '12-lyndarum-drive-epping-3076',
  ...
  },
  {
    ...
    propertyType: 'Townhouse',
    address: {
      display: '8 Bindts Road, Wollert VIC 3750',
      street: '8 Bindts Road',
      suburb: 'Wollert',
      state: 'VIC',
      postcode: '3750',
    },
    price: { display: 'Leased — $560 / wk', from: 560 },
    beds: 3,
    baths: 2,
    cars: 2,
    landSize: 320,
    description: 'Immaculate contemporary home leased after first open inspection. Multiple vetted applicants competed.',
    features: ['Solar Panels', 'Stone Benchtops', 'Internal Garage Access'],
    media: [
      { url: '/images/listing-6.jpg', alt: '8 Bindts Road, Wollert — Leased to executive tenants', type: 'image' },
    ],
    inspections: [],
    agents: [
      { name: 'Chirag Yadav', phone: '0479 092 216', email: 'chirag@krishrealestate.com.au', photo: '/images/agent-chirag.jpg' },
    ],
    slug: '8-bindts-road-wollert-3750',
  ...
  },
  {
    ...
    price: { display: 'Sold — $760,000', from: 760000 },
    beds: 4,
    baths: 2,
    cars: 2,
    landSize: 480,
    description: 'Premium single-level family residence with expansive entertaining deck, designer kitchen, and landscaped gardens in prime Wollert pocket.',
    features: ['Deck', 'Ducted Heating', 'Evaporative Cooling', 'Walk-in Pantry', 'Double Garage'],
    media: [
      { url: '/images/hero-property.jpg', alt: '22 Wollemi Avenue, Wollert — Sold for $760,000', type: 'image' },
    ],
    inspections: [],
    agents: [
      { name: 'Chirag Yadav', phone: '0479 092 216', email: 'chirag@krishrealestate.com.au', photo: '/images/agent-chirag.jpg' },
    ],
    slug: '22-wollemi-avenue-wollert-3750',
